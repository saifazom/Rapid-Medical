...
/* harmony import */ var _slick_min_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./slick.min.js */ "./src/assets/js/slick.min.js");
...
jQuery('.js-home-slideshow').slick({
  autoplay: true,
  prevArrow: jQuery('#home-slideshow-prev'),
  nextArrow: jQuery('#home-slideshow-next'),
  dots: true,
  speed: 300,
  autoplaySpeed: 3000,
  useCSS: false,
  ...
  appendDots: jQuery('.s-home-slideshow-controller'),
  infinite: true,
  pauseOnFocus: false,
  pauseOnHover: false,
  touchMove: true,
...
jQuery('.js-trending-slider').slick({
  autoplay: true,
  prevArrow: jQuery('#trending-slider-prev'),
  nextArrow: jQuery('#trending-slider-next'),
  dots: true,
  speed: 400,
  autoplaySpeed: 3000,
  useCSS: false,
  ...
  slidesToScroll: 1,
  adaptiveHeight: true,
  appendDots: jQuery('.s-trending-slider-controller'),
  infinite: true,
  pauseOnFocus: false,
  pauseOnHover: false,
  touchMove: true,
...
jQuery('.js-top-brrands').slick({
  autoplay: true,
  prevArrow: jQuery('#top-brrands-prev'),
  nextArrow: jQuery('#top-brrands-next'),
  dots: false,
  speed: 900,
  autoplaySpeed: 1500,
  useCSS: false,
...
var self = undefined,
    $navListItem = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.s-sidebar-nav li.menu-item-has-children > a'),
    $navListItemParentAll = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.s-sidebar-nav li.menu-item-has-children'),
    $navListItemAll = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.s-sidebar-nav > li'),
    $sidebarNavOpener = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-sidebar-nav-open'),
    $sidebarNavCloser = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.js-sidebar-nav-close'),
    $sidebarNav = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#sidebar-nav'),
    $currentMenuItem = $sidebarNav.find('current-menu-item');
$navListItem.click(function (e) {
  e.preventDefault(); //console.log('cool2');

  var $handler = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this),
      $parentItem = $handler.parent('li');
  $navListItemAll.removeClass('current-menu-item');
  $navListItemParentAll.removeClass('current-menu-parent');
  $parentItem.toggleClass('current-menu-parent');

  if ($parentItem.find('ul').hasClass('sub-menu-open')) {
    $parentItem.find('.sub-menu-open').removeClass('sub-menu-open').slideUp();
  } else {
    $sidebarNav.find('.sub-menu-open').removeClass('sub-menu-open').slideUp();
    $parentItem.find('ul').addClass('sub-menu-open').slideDown();
  }
});
...
jQuery('.c-secondary-nav__dot').click(function () {
  if (jQuery('.c-secondary-nav__items').hasClass("active")) {
    jQuery('.c-secondary-nav__items').removeClass("active");
  } else {
    jQuery('.c-secondary-nav__items').addClass("active");
  }
});
jQuery(window).scroll(function () {
...
(function($) {
  jQuery('.c-faq__items').on('click', '.c-faq__title', function(){
      /* Config Section */
      var duration = 400;
      var easing = 'swing';
      var scrollTo = true;
      var scrollToOffset = 170;

      /* Variables */
      var handler = jQuery(this);
      var allSection  = jQuery('.c-faq__section');
      var allContent = jQuery('.c-faq__content');
      var choosedSection = handler.closest('.c-faq__section');
      var choosedContent = choosedSection.find('.c-faq__content');
      var targetOffset = choosedSection.offset().top-scrollToOffset;

      /* Adding exceptions */
      // if(choosedSection.hasClass('selected')) return;

      if(choosedSection.hasClass('selected')) {
        choosedSection.removeClass('selected');
      ...
      if(scrollTo == true){
          ...
          choosedContent.slideDown(duration, easing, function(){
              ...
              allSection.removeClass('selected');
              choosedSection.addClass('selected');
          });
      }else{
          allContent.slideUp(duration, easing);
          choosedContent.slideDown(duration, easing, function(){
...
module.exports = __webpack_require__(/*! /Applications/MAMP/htdocs/maddhom-root/maddhom/src/assets/js/app.js */"./src/assets/js/app.js");
